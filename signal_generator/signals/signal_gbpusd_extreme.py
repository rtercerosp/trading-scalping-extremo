...
class SignalGBPExtreme(ISignalGenerator):
    def __init__(self, properties: SmartMoneySignalProps, connector: PlatformConnector):
        ...
        extreme_params = getattr(config, "EXTREME_SCALPING_PARAMS", {}).get("GBPUSD", {})
        self.sl_atr_mult = extreme_params.get("sl_atr_mult", 0.85)
        self.tp_atr_mult = extreme_params.get("tp_atr_mult", 2.4)
        self.min_atr_points = 18
        self.max_atr_points = 600

        self._allowed_symbols = ["GBPUSD", "GBPUSDc"]
